          ...
          >
            <div className="glass-effect rounded-2xl p-8">
              ...
              <p className="text-muted mb-6">
                ...
                opportunities to be part of your vision. Whether you need a full
                website, a feature enhancement, or just want to chat about tech,
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:your.email@example.com" className="text-muted hover:text-accent transition-colors">
